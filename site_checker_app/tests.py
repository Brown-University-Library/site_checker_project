...
class UtilityCodeTests(TestCase):
    ...
    #     s.url = (
    #         settings_app.TEST_SITE_URL_TO_FUNKY_PDF
    #     )  # reading this PDF throws unicode error
    ...
    #     s.recent_checked_time = timezone.make_aware(
    ...
    #     s.text_expected = 'Featured collections'
    #     s.check_frequency_number = 1
    #     s.check_frequency_unit = 'minute'
    #     s.email_addresses = settings_app.TEST_EMAIL
